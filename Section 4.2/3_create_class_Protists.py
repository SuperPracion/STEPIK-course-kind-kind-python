...
lst_animals = [*filter(lambda obj: isinstance(obj, Animals), lst_objs)]
lst_plants = [*filter(lambda obj: isinstance(obj, Plants), lst_objs)]
lst_mammals = [*filter(lambda obj: isinstance(obj, Mammals), lst_objs)]
